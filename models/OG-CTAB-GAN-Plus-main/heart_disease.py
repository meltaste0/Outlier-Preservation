...
def run_experiment(
    ...
    fake_dir = script_dir / "Fake_Datasets" / "Heart_Disease" / "synthetic_heart_disease_ctabgan_NOtail_100epochs.csv"
    ...
    outputs_dir = script_dir / "Fake_Datasets" / "Heart_Disease" / "metrics300"
